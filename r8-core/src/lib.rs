...
pub enum Instruction {
    ...
    Subtract { register1: Register, register2: Register },
    SubtractNotBorrow { register1: Register, register2: Register },
    ...
    DrawSprite { x_register: Register, y_register: Register, length: u8 },
}